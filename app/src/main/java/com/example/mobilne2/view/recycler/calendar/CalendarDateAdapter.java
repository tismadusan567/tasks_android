...
public class CalendarDateAdapter extends ListAdapter<CalendarDate, CalendarDateAdapter.ViewHolder> {
    private final Consumer<CalendarDate> onTaskClicked;

    public CalendarDateAdapter(@NonNull DiffUtil.ItemCallback<CalendarDate> diffCallback, Consumer<CalendarDate> onTaskClicked) {
        super(diffCallback);
